...
export default function AdminCVPage() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white p-6 pt-40">
      ...
      >
        <h1 className="text-3xl font-bold mb-8 text-center text-teal-400">Gestion du CV</h1>
            ...
            <p className="text-gray-300 text-center">
              {file ? (
                ...
                <>
                  ...
                  <span className="text-teal-400 underline">choisis-en un</span>
                </>
              )}
            </p>
            <input
        ...
        {previewUrl && (
          ...
          >
            <h2 className="text-xl font-semibold mb-6 text-center text-gray-200">CV actuel :</h2>
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{fileSize || 'Taille inconnue'}</p>
                  </div>
                </div>
              ...
              {showPreview && (
                ...
                >
                  ...
                  <p className="text-center mt-3 text-gray-400 text-sm">
                    ...
                    <a href={previewUrl} target="_blank" className="text-teal-400 underline">
