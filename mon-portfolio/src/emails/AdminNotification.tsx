        ...
        <Body style={main}>
            <Container style={container}>
                ...
                <Section style={section}>
                    <Text style={field}><strong>Nom :</strong> {name}</Text>
...
const paragraph = { fontSize: '16px', lineHeight: '26px', backgroundColor: '#f4f4f4', padding: '15px', borderRadius: '5px' };
const section = { padding: '24px', border: 'solid 1px #dedede', borderRadius: '5px', textAlign: 'left' as const };
